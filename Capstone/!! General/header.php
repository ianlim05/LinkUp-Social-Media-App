...
if ($isLoggedIn) {
    ...
    $profilepicture = !empty($_SESSION['profile_picture']) ? '../!! Images/' . $_SESSION['profile_picture'] : '../!! Images/user_icon.jpg'; 
...
<body class="h-body">
    <header class="h-header">
        <div class="h-logo"><a href="../Homepage/Homepage.php"><img src="../!! Images/LinkUp-logo1.png" alt="logo"></a></div>
        <nav class="h-nav">
            <a href="../Homepage/Homepage.php">Home</a>
            <a href="../Explore/searchuser.php">Explore</a>
            <a href="../Create Post/Create_Post.php">Post</a>
            <a href="../View Own Profile/ViewOwnProfile.php">Profile</a>
